...
-- 이제는 합계를 구하는데 7을 제외하고 1000을 넘으면 그만 루프를 나가는 procedure를 만들어보자.
...
begin
    ...
    -- while문을 mywhile이란 라벨로 설정했다.
    mywhile: while(i<=100) do
		if( (i % 7) = 0) then 		-- 7로 나눠서 나머지가 0 이면 7의 배수란 소리다.
			set i = i + 1;
			iterate mywhile; 			-- iterate는 다른 언어에서 continue랑 동일하다.
		end if;
